...
namespace Tank1
{
    public partial class Form1 : MetroForm
    {
        ...
        { if(n==2){
        btn.Text = n.ToString();
            btn.BackgroundImage = Image.FromFile(@"C:\Users\Jayan\Desktop\Tank\TankJC\Tank1\Tank1\image\brick.png");

        }
        else if (n == 3)
        {
            btn.Text = n.ToString();
            btn.BackgroundImage = Image.FromFile(@"C:\Users\Jayan\Desktop\Tank\TankJC\Tank1\Tank1\image\stone.jpg");

        }
        else if (n == 4)
        {
            btn.Text = n.ToString();
            btn.BackgroundImage = Image.FromFile(@"C:\Users\Jayan\Desktop\Tank\TankJC\Tank1\Tank1\image\water.jpg");
                ...
                for (int x = 2; x < lines.Length; x++) {
                    ...
                    for (int y = 0; y < sublines.Length; y++) {
                        string[] cell = Regex.Split(sublines[y], ",");
                         ...
                         int b;
                         try { b = Int32.Parse(cell[1]);
                         }
                         catch (Exception e)
                         {
                             b = Int32.Parse((cell[1])[0].ToString());
                         }
                        
                            updateBtbn(btns[a,b], x);
